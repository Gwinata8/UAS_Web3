			  ...
			  <li class="nav">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
								<a class="dropdown-item" href="<?=base_URL('home/spek');?>">Spesifikasi</a>
								<a class="dropdown-item" href="<?=base_URL('home/galeri');?>">Galeri</a>
								<a class="dropdown-item" href="<?=base_URL('home/rekom');?>">Rekomendasi</a>
							</div>
						</li>
						</ul>
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
								<a class="dropdown-item" href="<?=base_URL('home/profile');?>">Ubah Profile</a>
