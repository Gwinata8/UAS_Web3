...
<div class="container-fluid">
		<div class="container mb-5">
                <div class="row">
					...
					<h3 style="text-align:center; color: white"><b>Reset Password?</b></h3>
					<?php				
					...
					if(!empty($success)){?>
						...
						<a href="<?=base_url('admin/user_list');?>" style="color:white;">Back</a>
					<?php } else{?>
                    <form action="#" method="POST" style="color: white">                    
				        ...
				        <div class="mt-3">
							...
							<a type="button" class="btn btn-danger" href="<?=base_URL('admin/user_list');?>">Cancel</a>
                        </div>						
                    </form>
					<?php }?>
                    </div>
